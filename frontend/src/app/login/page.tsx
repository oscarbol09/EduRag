  ...
  return (
    <AuthLayout title="Inicia sesión en tu cuenta">
      ...
      <div className="mt-6 pt-6 border-t border-zinc-100">
        <p className="text-[11px] text-zinc-400 text-center mb-3">Autenticación institucional</p>
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 py-2 border border-zinc-200 rounded-lg opacity-60 cursor-not-allowed bg-zinc-50 text-zinc-500 text-xs font-medium"
          >
