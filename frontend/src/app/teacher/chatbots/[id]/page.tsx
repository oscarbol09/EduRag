        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center gap-3">
              <Link href={`/chat/${chatbot.id}`} className="px-4 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200">
                Probar
              </Link>
                ...
                <div className="flex items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 cursor-pointer transition-colors">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500">
                      {isUploading ? "Subiendo..." : "Arrastra o haz clic para subir documentos"}
                    </p>
                    <p className="text-xs text-gray-400 mt-1">PDF, DOCX (máx 20MB)</p>
                  </div>
                </div>
