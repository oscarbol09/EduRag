...
export default function EditChatbotClient() {
  ...
  const toggleBtn = (active: boolean) =>
    `flex-1 py-1.5 px-2 text-xs font-medium rounded-md text-center transition-colors focus:outline-none focus:ring-1 focus:ring-zinc-600 btn-press ${
      active
        ...
        actions={
          <div className="flex items-center gap-2 sm:gap-3">
            <Link
              ...
              className="btn-press px-3.5 py-1.5 bg-zinc-900 hover:bg-zinc-800 text-zinc-200 hover:text-white border border-zinc-800 rounded-lg font-medium text-xs transition-colors inline-flex items-center gap-1.5"
            >
            ...
            {chatbot.is_published ? (
              <button
                ...
                className="btn-press px-3.5 py-1.5 bg-amber-950/50 hover:bg-amber-900/60 text-amber-300 border border-amber-500/40 rounded-lg font-medium text-xs transition-colors disabled:opacity-50 inline-flex items-center gap-1.5"
              >
              ...
              <button
                ...
                disabled={isPublishing}
                className="btn-press px-3.5 py-1.5 bg-emerald-950/50 hover:bg-emerald-900/60 text-emerald-300 border border-emerald-500/40 rounded-lg font-medium text-xs transition-colors disabled:opacity-50 inline-flex items-center gap-1.5"
              >
      ...
      <main className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 flex-1">
        <div className="grid lg:grid-cols-12 gap-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-5 border-b border-zinc-800/80 pb-4">
                <div>
                  ...
                  <p className="text-[11px] text-zinc-500 font-mono mt-0.5">ID: {chatbot.id}</p>
                </div>
              ...
              <form onSubmit={handleSave} className="space-y-4">
                <div>
                  <label htmlFor="name" className="block text-xs font-medium text-zinc-300 mb-1 flex items-center gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 bg-zinc-900 border border-zinc-800 rounded-lg focus:ring-1 focus:ring-zinc-600 focus:border-zinc-600 outline-none text-xs text-zinc-100 placeholder-zinc-500 transition-colors font-sans"
                    required
                  />
                </div>

                <div>
                  <label htmlFor="subject_area" className="block text-xs font-medium text-zinc-300 mb-1 flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-2 gap-3 pt-1">
                  <div>
                    ...
                    <div role="radiogroup" aria-label="Nivel educativo" className="flex gap-1 bg-zinc-950 p-1 rounded-lg border border-zinc-800">
                      {([
                  ...
                  <div>
                    ...
                    <div role="radiogroup" aria-label="Tono de comunicación" className="flex gap-1 bg-zinc-950 p-1 rounded-lg border border-zinc-800">
                      {([
                ...
                <div className="grid grid-cols-2 gap-3 pt-1">
                  <div>
                    ...
                    <div role="radiogroup" aria-label="Nivel de restricción" className="flex gap-1 bg-zinc-950 p-1 rounded-lg border border-zinc-800">
                      {([
                  ...
                  <div>
                    ...
                    <div role="radiogroup" aria-label="Proveedor LLM" className="flex gap-1 bg-zinc-950 p-1 rounded-lg border border-zinc-800">
                      <button
                        type="button"
                        role="radio"
                      ...
                      <button
                        ...
                        disabled
                        aria-disabled="true"
                        className="flex-1 py-1.5 px-2 text-xs font-medium rounded-md text-center opacity-30 cursor-not-allowed text-zinc-500"
                      >
                        Claude
                      </button>
                    </div>
                ...
                <div>
                  <label htmlFor="welcome_message" className="block text-xs font-medium text-zinc-300 mb-1 flex items-center gap-1">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={2}
                    className="w-full px-3.5 py-2 bg-zinc-900 border border-zinc-800 rounded-lg focus:ring-1 focus:ring-zinc-600 focus:border-zinc-600 outline-none text-xs text-zinc-100 placeholder-zinc-500 transition-colors font-sans resize-none"
                  />
                </div>

                <div>
                  <label htmlFor="system_prompt_override" className="block text-xs font-medium text-zinc-300 mb-1 flex items-center gap-1">
                    Instrucciones didácticas personalizadas <HelpTooltip text="Pautas que debe acatar el LLM." />
                  </label>
                  <textarea
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="btn-press w-full py-2.5 bg-zinc-100 hover:bg-white text-zinc-950 rounded-lg font-medium text-xs transition-colors disabled:opacity-50 inline-flex items-center justify-center gap-2"
                >
                  {isSaving ? (
                    <>
              ...
              <div className="mt-6 pt-5 border-t border-zinc-800/80">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="text-[11px] text-zinc-400 hover:text-zinc-200 transition-colors btn-press inline-flex items-center gap-1"
                  >
                ...
                <div className="relative">
                  <textarea
                    ...
                    className="w-full px-3 py-2 text-[11px] bg-zinc-950 border border-zinc-800 rounded-lg font-mono text-zinc-300 cursor-text resize-none focus:outline-none focus:border-zinc-700"
                  />
                </div>
              </div>
            )}
          ...
          <div className="lg:col-span-5 card-clean rounded-xl p-6 sm:p-7 border border-zinc-800/80 bg-zinc-900/30 flex flex-col">
                ...
                <div className={`flex items-center justify-center w-full h-32 border-2 border-dashed rounded-xl transition-colors ${
                  ...
                  <div className="text-center p-4">
                    {isUploading ? (
                      ...
                      <div className="w-9 h-9 rounded-lg bg-zinc-800/80 border border-zinc-700/60 text-zinc-300 flex items-center justify-center mx-auto mb-2">
                    ...
                    <p className="text-[11px] text-zinc-500 mt-0.5">PDF, DOCX, TXT, MD (máx 20 MB)</p>
                  </div>
                </div>
                <input
                  type="file"
            ...
            {/* File List */}
            {documents.length === 0 ? (
              <div className="text-center py-12 text-zinc-500 text-xs flex-1 flex flex-col items-center justify-center border border-zinc-800/60 rounded-lg bg-zinc-950/40 p-6">
                ...
                <p className="font-medium text-zinc-300 mb-0.5">Sin documentos indexados</p>
              ...
              <div className="space-y-2.5 flex-1 overflow-auto max-h-[420px] pr-1">
                {documents.map((doc) => (
                  <div
                    key={doc.id}
                    className="flex items-center justify-between p-3 bg-zinc-950/60 rounded-lg border border-zinc-800/80 hover:border-zinc-700 transition-colors group"
                  >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <button
                        ...
                        className="btn-press p-1.5 text-zinc-500 hover:text-rose-400 hover:bg-rose-950/20 rounded-md transition-colors"
